    ...
    <div className="bg-card rounded-2xl p-4">
      ...
      <div className="flex items-center gap-4">
        <div className="text-center">
          <div
            className={`font-serif text-3xl font-bold leading-none ${OHAENG_TEXT[GAN_OHAENG[seun.gan]]}`}
          >
            {seun.gan}
          </div>
          <div
            className={`font-serif text-3xl font-bold leading-none mt-1 ${OHAENG_TEXT[JI_OHAENG[seun.ji]]}`}
          >
            {seun.ji}
          </div>
        </div>
