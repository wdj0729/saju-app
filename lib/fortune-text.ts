...
export const FORTUNE_TEXT: Record<string, FortuneEntry> = {
  甲: {
    오늘: {
      summary:
        '추진력이 강해지는 날입니다. 미뤄두었던 계획을 과감히 실행할 좋은 기회입니다. 주변 사람들의 신뢰를 한몸에 받을 수 있습니다.',
      details: {
    ...
    이달: {
      summary:
        '한 달 내내 진취적 기운이 이어집니다. 새로운 도전을 시작하기에 좋은 달입니다. 주도적인 역할이 긍정적 결과를 가져올 것입니다.',
      details: {
    ...
    올해: {
      summary:
        '크게 성장하는 해입니다. 오랫동안 준비해온 일들이 결실을 맺을 가능성이 높습니다. 자신감을 갖고 나아가세요.',
      details: {
  ...
  乙: {
    오늘: {
      summary:
        '유연한 대처가 빛을 발하는 날입니다. 무리하게 밀어붙이기보다 상황에 맞게 흘러가는 것이 유리합니다. 섬세한 감각이 주변의 호감을 삽니다.',
      details: {
    ...
    이달: {
      summary:
        '부드러운 추진력으로 원하는 바를 이루는 달입니다. 협력과 조화 속에서 성과를 거둘 수 있습니다. 감수성이 예민해져 창의적 아이디어가 풍부해집니다.',
      details: {
    ...
    올해: {
      summary:
        '꾸준한 노력이 빛을 발하는 해입니다. 겉으로 드러나지 않아도 내실 있는 성장이 이어집니다. 느리지만 확실하게 목표를 향해 나아가는 한 해입니다.',
      details: {
  ...
  丙: {
    오늘: {
      summary:
        '밝고 활기찬 에너지로 주변을 빛내는 날입니다. 적극적으로 나서면 좋은 결과가 따라옵니다. 열정이 넘쳐 어떤 일도 즐겁게 처리할 수 있습니다.',
      details: {
        대운: '눈에 띄는 활약이 기대됩니다. 발표나 프레젠테이션에 유리한 날입니다.',
        재물: '활발한 활동으로 재물 기회가 생깁니다. 단, 과소비에 주의하세요.',
        건강: '넘치는 에너지를 잘 분배하세요. 심장과 혈압 관리에 신경 쓸 필요가 있습니다.',
        인간관계:
          '밝은 태도가 주변에 긍정적인 영향을 줍니다. 새로운 만남이 기분 좋게 이루어집니다.',
      },
    },
    이달: {
      summary:
        '열정과 추진력이 최고조에 달하는 달입니다. 어떤 일을 시작하든 긍정적인 에너지가 함께합니다. 주변 사람들에게 활력을 불어넣는 존재가 됩니다.',
      details: {
    ...
    올해: {
      summary:
        '화려하게 빛나는 한 해입니다. 노력과 열정이 인정받아 큰 성취를 이룰 수 있습니다. 주변 사람들에게 영감을 주는 존재로 자리매김하는 해입니다.',
      details: {
  ...
  丁: {
    오늘: {
      summary:
        '집중력이 극대화되는 날입니다. 세밀한 작업이나 창의적인 일에서 뛰어난 성과를 낼 수 있습니다. 내면의 감수성이 풍부해져 예술적 영감이 떠오릅니다.',
      details: {
    ...
    이달: {
      summary:
        '꾸준한 집중력으로 의미 있는 성과를 내는 달입니다. 겉으로 화려하지 않아도 내실 있는 결과물이 나옵니다. 섬세한 감각이 주변에 인정받습니다.',
      details: {
    ...
    올해: {
      summary:
        '묵묵히 쌓아온 전문성이 빛을 발하는 해입니다. 한 분야에 깊이 파고드는 노력이 큰 결실로 이어집니다. 완성도 높은 성과물로 인정받는 한 해입니다.',
      details: {
  ...
  戊: {
    오늘: {
      summary:
        '안정감이 넘치는 하루입니다. 흔들리지 않는 중심으로 주변 사람들에게 신뢰를 줍니다. 포용력 있는 태도가 갈등을 부드럽게 해결합니다.',
      details: {
    ...
    이달: {
      summary:
        '안정 속에서 꾸준한 성장을 이루는 달입니다. 변화보다는 지속성을 유지하는 것이 유리합니다. 신중한 판단으로 좋은 결정을 내릴 수 있습니다.',
      details: {
    ...
    올해: {
      summary:
        '굳건한 기반 위에서 한 단계 도약하는 해입니다. 오랜 기간 쌓아온 신뢰가 큰 기회로 연결됩니다. 안정 속에서 꾸준한 발전을 이루는 한 해입니다.',
      details: {
  ...
  己: {
    오늘: {
      summary:
        '꼼꼼하고 실용적인 능력이 빛나는 날입니다. 세밀한 부분까지 챙기는 능력으로 신뢰를 얻을 수 있습니다. 현실적인 판단이 좋은 결과를 가져옵니다.',
      details: {
        ...
        인간관계:
          '성실하고 책임감 있는 태도가 신뢰를 쌓습니다. 작은 약속도 지키는 것이 중요합니다.',
      },
    },
    이달: {
      summary:
        '실용적이고 현실적인 접근으로 성과를 내는 달입니다. 세부 사항을 꼼꼼히 챙기는 것이 큰 차이를 만듭니다. 착실한 노력이 눈에 보이는 결과로 나타납니다.',
      details: {
        ...
        인간관계:
          '성실함과 진실함이 주변의 신뢰를 얻습니다. 조용히 베푸는 선행이 관계를 풍요롭게 합니다.',
      },
    },
    올해: {
      summary:
        '착실하고 꼼꼼한 노력이 인정받는 한 해입니다. 현실 감각이 뛰어나 실용적인 성과를 거둡니다. 묵묵히 자신의 길을 걷는 것이 결국 가장 빠른 길입니다.',
      details: {
        ...
        인간관계:
          '오래되고 믿을 수 있는 관계가 더욱 빛나는 해입니다. 진실한 인연을 소중히 가꾸세요.',
      },
    },
  },
  庚: {
    오늘: {
      summary:
        '결단력이 요구되는 상황에서 빛나는 날입니다. 망설이지 말고 과감하게 결정을 내리세요. 의리와 책임감이 주변 사람들에게 깊은 인상을 남깁니다.',
      details: {
    ...
    이달: {
      summary:
        '강한 추진력으로 장애물을 돌파하는 달입니다. 단호한 결정이 막혀있던 문제를 풀어줍니다. 책임감 있는 모습이 리더로서의 면모를 드러냅니다.',
      details: {
    ...
    올해: {
      summary:
        '큰 결단을 내리고 새로운 길을 여는 한 해입니다. 과감한 도전이 예상보다 훨씬 좋은 결과를 가져옵니다. 의지와 실행력이 올해의 핵심 키워드입니다.',
      details: {
  ...
  辛: {
    오늘: {
      summary:
        '예민한 감각이 날카롭게 살아있는 날입니다. 완성도를 높이는 작업에서 탁월한 능력을 발휘합니다. 심미적 안목이 빛나는 하루입니다.',
      details: {
        ...
        인간관계:
          '섬세한 배려가 상대방에게 깊은 인상을 남깁니다. 작은 것에도 세심하게 신경 써주세요.',
      },
    },
    이달: {
      summary:
        '섬세함과 완벽주의가 높은 성과로 이어지는 달입니다. 퀄리티를 중시하는 자세가 주변의 인정을 받습니다. 예술적 감각이 돋보이는 시기입니다.',
      details: {
        ...
        인간관계:
          '섬세한 공감 능력이 관계를 풍요롭게 합니다. 친밀한 관계에서 더 큰 기쁨을 찾으세요.',
      },
    },
    올해: {
      summary:
        '완성도 높은 결과물로 이름을 알리는 한 해입니다. 세밀한 노력의 축적이 올해 빛을 발합니다. 미적 감각과 전문성이 인정받는 해입니다.',
      details: {
        ...
        인간관계:
          '진지하고 깊이 있는 관계가 형성되는 해입니다. 소수의 진정한 인연이 삶을 풍요롭게 합니다.',
      },
    },
  },
  壬: {
    오늘: {
      summary:
        '넓은 시야로 전체를 꿰뚫는 통찰이 빛나는 날입니다. 유연한 사고로 복잡한 문제를 쉽게 풀어냅니다. 지혜로운 판단이 좋은 선택으로 이어집니다.',
      details: {
        ...
        인간관계:
          '다양한 사람들과 원활하게 소통하는 날입니다. 사교적인 자리에서 좋은 인연이 생깁니다.',
      },
    },
    이달: {
      summary:
        '광활한 가능성이 펼쳐지는 달입니다. 다양한 방향에서 기회가 오며, 유연한 적응력이 강점입니다. 지혜로운 판단으로 좋은 선택을 이어가세요.',
      details: {
    ...
    올해: {
      summary:
        '넓은 시야와 유연한 적응력으로 큰 성취를 이루는 해입니다. 변화하는 환경에서도 흔들리지 않는 지혜가 빛납니다. 다양한 분야에서 성장이 이루어지는 한 해입니다.',
      details: {
        ...
        인간관계:
          '넓은 인맥이 큰 기회를 불러오는 해입니다. 다양한 사람들과의 연결이 삶을 풍요롭게 합니다.',
      },
    },
  },
  癸: {
    오늘: {
      summary:
        '직관력이 예리하게 발동하는 날입니다. 겉으로 드러나지 않은 진실을 꿰뚫어 보는 통찰이 강해집니다. 내면의 목소리에 귀를 기울이면 좋은 결정을 내릴 수 있습니다.',
      details: {
    ...
    이달: {
      summary:
        '깊은 내면 세계가 풍요로워지는 달입니다. 직관과 창의성이 최고조에 달해 독창적인 아이디어가 샘솟습니다. 감성이 풍부해져 예술적 표현에서 특히 빛납니다.',
      details: {
    ...
    올해: {
      summary:
        '내면의 지혜가 꽃을 피우는 한 해입니다. 오랫동안 준비해온 꿈이 현실로 이루어질 조건이 갖춰집니다. 직관과 통찰로 중요한 기회를 놓치지 않는 해입니다.',
      details: {
        ...
        인간관계:
          '진정한 이해와 공감을 나눌 수 있는 깊은 관계가 형성되는 해입니다. 인연의 깊이를 소중히 여기세요.',
      },
    },
  },
};
